...
import com.company.Exceptions.ClassNotRegistedException;
...
//                        }
            ...
            if (!flag)
                throw new ClassNotRegistedException("pass in objects class pattern " + Arrays.toString(objClass.toArray()) + " is not registered in any config files");
        }
